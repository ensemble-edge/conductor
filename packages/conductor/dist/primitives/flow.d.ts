 ...
 */
import type { FlowStepType, ParallelFlowStep, BranchFlowStep, ForeachFlowStep, TryFlowStep, SwitchFlowStep, WhileFlowStep, MapReduceFlowStep, ParallelOptions, BranchOptions, ForeachOptions, TryOptions, WhileOptions, MapReduceOptions } from './types.js';
 ...
 * ```
 */
export declare function parallel(steps: FlowStepType[], options?: ParallelOptions): ParallelFlowStep;
/**
 ...
 * ```
 */
export declare function branch(condition: unknown, options: BranchOptions): BranchFlowStep;
/**
 ...
 * ```
 */
export declare function ifThen(condition: unknown, steps: FlowStepType[]): BranchFlowStep;
/**
 ...
 * ```
 */
export declare function ifThenElse(condition: unknown, thenSteps: FlowStepType[], elseSteps: FlowStepType[]): BranchFlowStep;
/**
 ...
 * ```
 */
export declare function foreach(items: unknown, stepToExecute: FlowStepType, options?: ForeachOptions): ForeachFlowStep;
/**
 ...
 * ```
 */
export declare function tryStep(steps: FlowStepType[], options?: TryOptions): TryFlowStep;
/**
 ...
 * ```
 */
export declare function switchStep(value: unknown, cases: Record<string, FlowStepType[]>, defaultCase?: FlowStepType[]): SwitchFlowStep;
/**
 * Create a while loop
 *
 ...
 * ```
 */
export declare function whileStep(condition: unknown, steps: FlowStepType[], options?: WhileOptions): WhileFlowStep;
/**
 ...
 * ```
 */
export declare function doWhile(steps: FlowStepType[], condition: unknown, options?: WhileOptions): FlowStepType[];
/**
 ...
 * ```
 */
export declare function doUntil(steps: FlowStepType[], condition: unknown, options?: WhileOptions): FlowStepType[];
/**
 ...
 * ```
 */
export declare function mapReduce(items: unknown, mapStep: FlowStepType, reduceStep: FlowStepType, options?: MapReduceOptions): MapReduceFlowStep;
/**
 ...
 * ```
 */
export declare function map(items: unknown, stepToExecute: FlowStepType, options?: ForeachOptions): ForeachFlowStep;
/**
 ...
 * ```
 */
export declare function repeat(count: number, steps: FlowStepType[]): ForeachFlowStep;
/**
 ...
 * ```
 */
export declare function race(steps: FlowStepType[]): ParallelFlowStep;
/**
 ...
 * ```
 */
export declare function fallback(steps: FlowStepType[]): FlowStepType;
