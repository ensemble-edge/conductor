...
export class PromptParser {
     ...
     */
    parse(template, variables, options) {
        const opts = {
            ...this.defaultOptions,
            ...this.options,
            ...options,
     ...
     */
    parseVariables(template, variables, options) {
        const regex = /\{\{([^#/][^}]*)\}\}/g;
     ...
     */
    parseConditionals(template, variables, options) {
     ...
     */
    parseLoops(template, variables, options) {
