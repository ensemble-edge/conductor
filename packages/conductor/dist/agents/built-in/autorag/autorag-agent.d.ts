...
/**
 * AutoRAG Agent - Dead simple RAG with zero configuration
 */
export declare class AutoRAGMember extends BaseAgent {
    run(ctx: AgentExecutionContext): Promise<AutoRAGAnswerResult | AutoRAGSearchResult>;
}
//# sourceMappingURL=autorag-agent.d.ts.map