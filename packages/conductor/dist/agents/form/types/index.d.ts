 ...
 */
export type FieldType = 'text' | 'email' | 'password' | 'number' | 'tel' | 'url' | 'textarea' | 'select' | 'checkbox' | 'radio' | 'date' | 'time' | 'datetime-local' | 'file' | 'hidden';
/**
 ...
 * Form configuration
 */
export interface FormAgentConfig extends AgentConfig {
