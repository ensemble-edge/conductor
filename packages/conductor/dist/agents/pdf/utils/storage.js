 ...
 * Store PDF to R2
 */
export async function storePdfToR2(pdf, config, env) {
 ...
 */
export function generateDefaultR2Key() {
 ...
 */
export function generateFilename(r2Key, configFilename, fallback = 'document.pdf') {
    if (configFilename) {
 ...
 */
export function createContentDisposition(mode, filename) {
    // Sanitize filename
