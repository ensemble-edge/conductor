 ...
 * ```
 */
export function requiresConsent(jurisdictions, purpose) {
 ...
 */
export function getConsentModel(jurisdictions) {
    if (jurisdictions.length === 0)
        return 'none';
 ...
 */
export function getRequiredConsentPurposes(jurisdictions) {
    const purposes = ['analytics', 'marketing', 'personalization', 'third_party'];
