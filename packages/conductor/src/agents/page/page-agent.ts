...
export class PageAgent extends BaseAgent {
  private pageConfig: PageAgentConfig
   ...
   */
  protected async run(context: AgentExecutionContext): Promise<PageMemberOutput> {
   ...
   * Load page component
   */
  private async loadComponent(context: AgentExecutionContext): Promise<PageComponent> {
