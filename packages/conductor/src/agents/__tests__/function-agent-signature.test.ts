...
describe('FunctionAgent function signature detection', () => {
  ...
  it('should match echo agent signature (input, ctx) pattern', async () => {
    // This simulates the actual echo agent from templates
    interface EchoInput {
      data: any
    }
    ...
    expect(echoHandler.length).toBe(2)
