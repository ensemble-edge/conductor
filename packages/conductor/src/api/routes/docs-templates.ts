 ...
 */
export function getThemeFromConfig(config?: DocsConfig): DocsTheme {
  return {
 ...
 */
function themeVariables(theme: DocsTheme): string {
  return `
    :root {
 ...
 */
const getCommonStyles = (theme: DocsTheme) => `
...
export function renderDocsLanding(props: DocsLandingProps): string {
  const content = `
...
export function renderAgentsList(props: AgentsListProps): string {
  const renderAgentCard = (agent: AgentsListProps['builtInAgents'][0]) => `
...
export function renderAgentDetail(props: AgentDetailProps): string {
...
export function renderEnsemblesList(props: EnsemblesListProps): string {
  const renderEnsembleCard = (ensemble: EnsemblesListProps['ensembles'][0]) => `
...
export function renderEnsembleDetail(props: EnsembleDetailProps): string {
  const content = `
    <div class="breadcrumb">
 ...
 */
export function renderOpenAPIUI(props: OpenAPIUIProps): string {
