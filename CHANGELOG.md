...
- 5947140: docs: update quick start to use ensemble conductor start
...
- 540674f: Add deployment configuration and tag-based deployment infrastructure
...
- 19df58a: Remove deprecated backward compatibility code
...
- e226033: - **Fix static assets URL mapping**: Public assets in `assets/public/` are now correctly served at root URLs (e.g., `/favicon.ico`, `/styles/reset.css`) instead of `/assets/public/*` paths. This aligns with how Wrangler's `directory` setting works as a document root.
