 ...
 */
export declare class QueriesMember extends BaseAgent {
    private readonly env;
    private queriesConfig;
    constructor(config: AgentConfig, env: ConductorEnv);
    protected run(context: AgentExecutionContext): Promise<QueriesOutput>;
    /**
...
//# sourceMappingURL=queries-agent.d.ts.map