 ...
 */
export declare class VectorizeRAGMember extends BaseAgent {
    run(ctx: AgentExecutionContext): Promise<VectorizeRAGResult>;
}
//# sourceMappingURL=vectorize-rag-agent.d.ts.map