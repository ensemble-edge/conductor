...
class MockSmsProvider {
    ...
    setValidateConfigShouldFail(shouldFail) {
...
describe('SmsMember', () => {
    ...
    describe('Single SMS Sending', () => {
        ...
        it('should throw error when provider validation fails', async () => {
            ...
            await expect(member['run']({ ...mockContext, input })).rejects.toThrow('Provider validation failed');
        });
    ...
    describe('Batch SMS Sending', () => {
        ...
        it('should track failed messages in batch', async () => {
            ...
            member.provider = failingProvider;
            const input = {
                recipients: [
                    { phone: '+12025551234' },
                    { phone: '+12025555678' },
        ...
        it('should continue batch send even if some messages fail', async () => {
            ...
            member.provider = intermittentProvider;
            const input = {
                recipients: [
                    { phone: '+12025551111' },
                    { phone: '+12025552222' },
    ...
    describe('Rate Limiting', () => {
        ...
        it('should properly space messages according to rate limit', async () => {
            ...
            member.provider = trackingProvider;
            const input = {
                recipients: [
                    { phone: '+12025551111' },
                    { phone: '+12025552222' },
