...
export class QueryCache {
    ...
    async get(sql, params, database) {
        try {
            ...
            if (this.enableStats)
                this.stats.errors++;
            return Result.err(Errors.internal('Cache get failed', error instanceof Error ? error : undefined));
        }
    }
    /**
    ...
    async set(sql, result, params, database, ttl) {
        try {
            ...
            if (this.enableStats)
                this.stats.errors++;
            return Result.err(Errors.internal('Cache set failed', error instanceof Error ? error : undefined));
        }
    }
    /**
    ...
    async delete(sql, params, database) {
        try {
            ...
            if (this.enableStats)
                this.stats.errors++;
            return Result.err(Errors.internal('Cache delete failed', error instanceof Error ? error : undefined));
        }
    }
    /**
    ...
    async clearDatabase(database) {
        try {
            ...
            if (this.enableStats)
                this.stats.errors++;
            return Result.err(Errors.internal('Cache clear failed', error instanceof Error ? error : undefined));
        }
    }
    /**
    ...
    async clearAll() {
        try {
            ...
            if (this.enableStats)
                this.stats.errors++;
            return Result.err(Errors.internal('Cache clear all failed', error instanceof Error ? error : undefined));
        }
    }
    /**
