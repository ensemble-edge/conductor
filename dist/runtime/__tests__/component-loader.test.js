...
describe('ComponentLoader', () => {
    ...
    describe('load', () => {
        ...
        it('should cache component after loading from KV', async () => {
            ...
            expect(mockCache.set).toHaveBeenCalledWith('components:template://components/header@v1.0.0', content, { ttl: 3600 });
        });
        ...
        it('should use custom TTL when provided', async () => {
            ...
            expect(mockCache.set).toHaveBeenCalledWith('components:template://components/header@v1.0.0', content, { ttl: 7200 });
        });
    ...
    describe('loadCompiled', () => {
        ...
        it('should handle compiled page exports', async () => {
            ...
            const page = await loader.loadCompiled('page://Dashboard@v1.0.0');
