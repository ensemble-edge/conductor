 ...
 */
import type { MemberScoringConfig, ScoringResult, ScoredExecutionResult, ScoreBreakdown } from './types.js';
export declare class ScoringExecutor {
    /**
     * Execute a member with scoring and retry logic
     */
    executeWithScoring<T = any>(executeMember: () => Promise<T>, evaluateOutput: (output: T, attempt: number, previousScore?: ScoringResult) => Promise<ScoringResult>, config: MemberScoringConfig): Promise<ScoredExecutionResult<T>>;
    /**
     * Apply backoff delay
     */
