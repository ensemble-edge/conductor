 ...
 */
export type AgentHandler<TInput = unknown, TOutput = unknown> = (context: AgentExecutionContext, input: TInput) => Promise<TOutput>;
/**
 ...
 */
export declare const isAgentStatus: (value: string) => value is AgentStatus;
/**
 * Type guard to check if a value is a valid AgentPriority
 */
export declare const isAgentPriority: (value: string) => value is AgentPriority;
/**
 * Create default agent config
 */
export declare const createDefaultAgentConfig: (name: AgentName, operation: Operation) => AgentConfig;
