 ...
 */
export class CloudflarePlatformV2 extends BasePlatformV2 {
 ...
 */
export function createCloudfarePlatformV2(modelsData, capabilitiesData) {
    return new CloudflarePlatformV2(modelsData, capabilitiesData);
}
