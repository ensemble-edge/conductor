/**
 * ThinkMember Tests with Dependency Injection
 *
 * Tests AI reasoning member with mock providers
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { ThinkMember } from '../../../src/members/think-member';
import type { MemberConfig } from '../../../src/runtime/parser';
import type { ProviderRegistry, AIProvider as AIProviderInterface, AIProviderConfig, AIProviderResponse, AIMessage } from '../../../src/members/think-providers';
...
describe('ThinkMember', () => {
	...
	describe('Constructor and Configuration', () => {
		it('should initialize with default config', () => {
			...
			const member = new ThinkMember(config, mockRegistry);
			const thinkConfig = member.getThinkConfig();
