/**
 * DataAgent Tests with Mock Repository
 *
 * Tests data operations agent with mock repository
 */
...
describe('DataAgent', () => {
	...
	describe('Constructor and Configuration', () => {
		...
		it('should throw error for missing operation', () => {
			...
			expect(() => new DataAgent(config, mockRepo)).toThrow('requires operation type');
		});
	...
	describe('GET Operation', () => {
		...
		it('should handle missing keys', async () => {
			...
			expect(result.success).toBe(true); // DataAgent returns success with found:false
			const data = result.data as any;
	...
	describe('PUT Operation', () => {
		...
		it('should handle repository errors on put', async () => {
			...
			expect(result.success).toBe(true); // DataAgent returns success with success:false field
			const data = result.data as any;
