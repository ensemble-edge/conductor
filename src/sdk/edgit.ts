 ...
 * ```
 */
export async function loadComponent(componentRef: string, env: Env): Promise<string> {
  ...
  throw new Error(
    'Edgit integration not yet implemented. Install @ensemble-edge/edgit when available.'
  )
}
 ...
 */
export async function listComponentVersions(componentName: string, env: Env): Promise<string[]> {
  // TODO: Integrate with Edgit
  throw new Error('Edgit integration not yet implemented')
}
