...
export class DocsMember extends BaseMember {
	private docsConfig: DocsMemberConfig;

	constructor(config: MemberConfig) {
		super(config);
		this.docsConfig = config as MemberConfig & DocsMemberConfig;
	 ...
	 */
	protected async run(context: MemberExecutionContext): Promise<DocsMemberOutput> {
	 ...
	 */
	private async serveDocsUI(context: MemberExecutionContext): Promise<DocsMemberOutput> {
	 ...
	 */
	private async generateSpec(context: MemberExecutionContext): Promise<any> {
	 ...
	 */
	private async autoGenerateSpec(context: MemberExecutionContext): Promise<any> {
		// This would scan your ensembles and members to generate the spec
...
<body>
	...
	private async cacheOutput(
		...
		await context.env.DOCS_CACHE?.put(
			cacheKey,
