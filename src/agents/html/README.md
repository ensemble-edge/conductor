...
Components support optional cache configuration, similar to agent-level caching:
...
The HTML agent automatically handles component caching based on Conductor's standard cache system. Cache configuration is typically set at the ComponentLoader level:
