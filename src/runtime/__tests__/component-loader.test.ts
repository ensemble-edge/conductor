...
describe('ComponentLoader', () => {
  ...
  describe('parseURI', () => {
    ...
    it('should throw on invalid protocol', () => {
      expect(() => loader.parseURI('invalid://components/header@latest')).toThrow(
  ...
  describe('load', () => {
    ...
    it('should throw when component not found', async () => {
      ...
      await expect(loader.load('template://components/missing@v1.0.0')).rejects.toThrow(
        'Component not found'
      )
    })
  ...
  describe('loadJSON', () => {
    ...
    it('should throw on invalid JSON', async () => {
      ...
      await expect(loader.loadJSON('config://settings@latest')).rejects.toThrow(
  ...
  describe('invalidateCache', () => {
    ...
    it('should handle missing cache gracefully', async () => {
      ...
      await expect(loaderWithoutCache.invalidateCache('template://header')).resolves.not.toThrow()
    })
  })
